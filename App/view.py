...
def print_menu():
    ...
    print("5- Consultar crimenes por área")
    #Todo's Sarah Agregar opción 5 en el menú, consultar por REPORTING_AREA
    print("0- Salir")
    print("*******************************************")
...
def main():
    ...
    while working:
        ...
        if int(inputs[0]) == 1:
            ...
            # Todo's Sarah lab 9, implementar el I/O e invocar las funcions de la opcion 5
            ...
            crimesArea = logic.get_crimes_by_range_area(control, initialArea, finalArea)
            print("\nTotal de crimenes en el rango de Áreas: " + str(crimesArea))
        else:
            sys.exit(0)
    sys.exit(0)
